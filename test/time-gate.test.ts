...
import { advanceTimeForKnownAction, alignStatusClock, extractClockTime, gateStatusTime, gateTimePatch, hasExplicitTimeAdvance, inferActionDuration } from "../src/time-gate.ts";
