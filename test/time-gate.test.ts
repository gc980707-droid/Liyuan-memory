...
import { advanceTimeForKnownAction, alignStatusClock, extractClockTime, gateStatusTime, gateTimePatch, hasExplicitTimeAdvance, inferActionDuration, projectStatusClock } from "../src/time-gate.ts";
...
test("通过门禁的状态栏时间可投影回账本时钟", () => {
	...
	assert.equal(advanceTimeForKnownAction("7月15日14:30", "起来上厕所"), "7月15日14:35");
});
